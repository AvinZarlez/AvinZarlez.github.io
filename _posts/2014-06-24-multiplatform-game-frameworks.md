...
author: DEADNAME
excerpt: |
  Welcome to part two of a new blog series I've started, "Ask DEADNAME"!
...
You can read [last Monday''s question](http://www.OLDURL/2014/06/think-multiplatform/) about multiplatform development. In [response](http://www.OLDURL/2014/06/think-multiplatform/#comments) to it, I got today''s question:
...
An even bigger factor is updates. Developer B was able to get to market faster, and will be able to deliver future updates will be much quickly than Developer A. As we know, we live in an [Apps as a Service](http://www.OLDURL/2013/10/apps-service-product/ "Apps are a service, not a product") world, and the more often you can update a game the better chance it will have.
...
Thanks to everybody so far so has sent me questions! I would love to hear from you and answer more. If you''d like to see your post on a future Ask DEADNAME [send me an email](http://www.OLDURL/contact/ "Contact") and ask away!
