...
Never made an app before? Not a problem! Microsoft has a bunch of resources and all the tools you need to get started and create awesome apps. Just go to <http://aka.ms/GetStartedNow> for more info. You can also check out my [resources](http://www.OLDURL/resources/ "Resources for Game and App Developers") page for game developers.
